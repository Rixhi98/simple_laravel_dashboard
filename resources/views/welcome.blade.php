...
@keyframes pulse {
    ...
    <body>
        <header>
        <div id="video-player"> 
            <video playsinline="playsinline" autoplay="autoplay" muted="muted" loop="loop" style="position: fixed;right: 0;bottom: 0;min-width: 100%;min-height: 100%;">
                ...
                <div >
                    <svg viewbox="0 0 700 225">
                        <clipPath id="textClip" class="filled-heading">
                            <text y="70">Welcome</text>
                            <text y="140"></text>
                            <text y="210"></text>
                            
                            <text y="70">To Kreatx</text>
                            <text y="140"></text>
                            <text y="210"></text>
                    
                            <text y="70">Dashboard</text>
                            <text y="140"></text>
                            <text y="210"></text>
                        </clipPath>
